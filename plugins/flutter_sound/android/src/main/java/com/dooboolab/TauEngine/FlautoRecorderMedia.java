...
public class FlautoRecorderMedia implements FlautoRecorderInterface {
	...
	// }
	static int codecArray[] = { MediaRecorder.AudioEncoder.DEFAULT, MediaRecorder.AudioEncoder.AAC,
			MediaRecorder.AudioEncoder.OPUS, 0, // CODEC_CAF_OPUS (specific Apple)
			0, // CODEC_MP3 (not implemented)
			MediaRecorder.AudioEncoder.VORBIS, 7, // MediaRecorder.AudioEncoder.DEFAULT // CODEC_PCM (not implemented)
			0, // wav
			0, // aiff
			0, // pcmCAF
			0, // flac
			MediaRecorder.AudioEncoder.AAC, // aacMP4
			MediaRecorder.AudioEncoder.AMR_NB, MediaRecorder.AudioEncoder.AMR_WB, 0, // pcm8
			0, // pcmFloat32
			0, // pcmWebM
	...
	static int formatsArray[] = { MediaRecorder.OutputFormat.DEFAULT // DEFAULT
			...
			, MediaRecorder.OutputFormat.AMR_NB, MediaRecorder.OutputFormat.AMR_WB, 0 // pcm8
			, 0 // pcmFloat32
	...
	static String pathArray[] = { "sound.fs" // DEFAULT
			, "sound.aac" // CODEC_AAC
	...
	// record
	private void startBlueRecording(String path) {
	...
	public void _startRecorder(Integer numChannels, Integer sampleRate, Integer bitRate, t_CODEC codec, String path,
			int audioSource, FlautoRecorder session) throws IOException, Exception {
	...
	public boolean resumeRecorder() {
		...
		if (Build.VERSION.SDK_INT < 24) {
			m_callback.log(Flauto.t_LOG_LEVEL.DBG, "Pause/Resume needs at least Android API 24");
			// result.error ( TAG, "Bad Android API level", "\"Pause/Resume needs at least
			// Android API 24\"" );
			return false;
		} else {
