...
class _SimpleRecorderState extends State<SimpleRecorder> {
  ...
  void record() async {
    var basepash = await saveVoiceDirectory(Get.arguments.title);
    var fileurl = await strogeFile(basepash, suffix: 'aac');
    playController.state.file = fileurl;
    print(fileurl);
    ...
    _timer = Timer.periodic(Duration(milliseconds: 60 * 5 * 1000), (t) {
      t.cancel();
      requestPermission();
          ...
          Container(
            ...
            child: Row(children: [
              ElevatedButton(
                ...
                child: Text(_mRecorder!.isRecording ? '停止' : '录制'),
              ),
              SizedBox(
                width: 20,
              ),
