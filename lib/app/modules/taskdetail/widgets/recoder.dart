...
class RecordWiew extends StatefulWidget {
  RecordWiew({Key? key}) : super(key: key);

  @override
  _RecordWiewState createState() => _RecordWiewState();
}

class _RecordWiewState extends State<RecordWiew> {
  ...
  Widget _actionShow() {
    var _width = ScreenUtil().screenWidth - 30;
  ...
  _startRecorder() async {
    try {
      ...
      String path =
          '${tempDir.path}/data-$time${ext[Codec.aacADTS.index]}';
      print('===>  准备开始录音');
